...
pub const PageJsApis = flattenTypes(&.{
    ...
    @import("../webapi/CacheStorage.zig"),
    @import("../webapi/Permissions.zig"),
    @import("../webapi/StorageManager.zig"),
    @import("../webapi/DeprecatedStorageQuota.zig"),
    ...
    @import("../webapi/RTCPeerConnection.zig"),
    @import("../webapi/event/RTCPeerConnectionIceEvent.zig"),
    ...
    @import("../webapi/audio/AudioNodes.zig"),
